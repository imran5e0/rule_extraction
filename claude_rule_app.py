...
def main():
    ...
    st.markdown("Upload a PDF document to automatically extract and analyze signing rules with checkboxes using Claude AI")
    ...
    with st.sidebar:
        ...
        st.markdown("This app uses Claude AI to intelligently analyze documents and extract signing rules with high accuracy.")
    ...
    if uploaded_file is not None:
        ...
        if st.button("🔍 Extract Signing Rules", type="primary", use_container_width=True):
            ...
            with st.spinner("Analyzing document for signing rules using Claude AI..."):
                try:
